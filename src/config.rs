    ...
    pub fn from_env() -> Result<Self> {
        ...
        let config = Self {
            ...
            app_name: env::var("APP_NAME")
                .unwrap_or_else(|_| "Hotel Restaurant".to_string()),
            app_currency: env::var("APP_CURRENCY")
